  ...
  return (
    <View style={style}>
      <Svg width={w} height={h}>
          ...
          return i != 5 ? (
            <View key={i}>
              <Line
                ...
                strokeWidth="6"
              />
              <Text x={65 + i * 40 - 12} y={h - 4} fontSize="12" fill="black">
                {data.date.slice(5, 10).replace('-', '/')}
              </Text>
            </View>
          ) : (
            <View key={i}>
              <Line
                ...
                strokeWidth="6"
              />
              <Text x={65 + i * 40 - 10} y={h - 4} fontSize="12" fill="black">
                Now
              </Text>
            </View>
          );
        ...
        <Text x="0" y="60" fontSize="15" fill="black">
          Goal
        </Text>
        <Text x={w - 34} y="60" fontSize="15" fill="black">
          {props?.max}
        </Text>
      </Svg>
    </View>
