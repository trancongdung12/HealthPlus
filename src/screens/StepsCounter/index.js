            ...
            <View style={style.topContainer}>
                <View style={style.selectDate} >
                    <TouchableOpacity style={{ marginRight:20 }} onPress={()=>preDay()} >
                        <SvgIcon.LeftArrow width={30} height={30} />
                    </TouchableOpacity>
                    <Text style={style.dateTitle}>Ngày {currentSteps.date}</Text>
                    <TouchableOpacity style={{ marginLeft:20 }} onPress={()=>nextDay()}>
                        <SvgIcon.RightArrow width={30} height={30}/>
                    </TouchableOpacity>
                </View>
                <Text style={style.titleDay}>
                   {dailySteps[index].date}
                </Text>
                ...
                <View style={style.stepsInfo}>
                    <View style={[style.InfoC]} >
                        ...
                        <Text style={style.infoData}>{Math.round(currentSteps.value*0.2,1)}</Text>
                    ...
                    <View style={[style.InfoC]} >
                        ...
                        <Text style={style.infoData}>{Math.round(currentSteps.value*0.0025,1)}</Text>
