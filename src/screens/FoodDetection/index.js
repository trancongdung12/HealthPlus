  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView
          ...
          <View style={styles.contentMain}>
            ...
            <View style={styles.contentList}>
              <View style={styles.listIt}>
                ...
                <Text style={styles.listTit}>
                  {response.length > 0 ? getDam() : 0}
                </Text>
              </View>
              <View style={styles.listIt}>
                <View style={styles.detGr}>
        ...
        <View style={styles.content}>
          <Text style={styles.contentTit}>
            Ingredients in the{' '}
            <Text style={{color: '#FD646F'}}>
              ...
              {response.length > 0 &&
                response.map((item, index) => (
                  <View style={styles.listIt} key={index}>
                    ...
                    <Text style={styles.listTit}>
                      {Math.round(item.value * 20 * 100) / 100}
                    </Text>
                  </View>
                ))}
            </View>
          ...
          {response.length > 0 && (
            <>
              ...
              <Dialog.Container
                ...
                <Dialog.Title style={{color: '#FD646F'}}>
                  Did you eat{' '}
                ...
                <Dialog.Description style={{fontSize: 16}}>
                  ...
                  <Text style={{color: '#FD646F'}}>
                    {response.length > 0 &&
                      Math.round(response.sum('value') * 20 * 100) / 100}
                  </Text>{' '}
                  calories
                </Dialog.Description>
                <Dialog.Description style={{fontSize: 12}}>
                  *Save nutrition information will help you easily keep track of
                  your nutrition
                </Dialog.Description>
          ...
          <Dialog.Container
            visible={isSaved}
            contentStyle={{justifyContent: 'center', alignItems: 'center'}}>
            <Dialog.Title style={{color: '#4B8311'}}>
              {' '}
              Your meal information has been saved successfully{' '}
            </Dialog.Title>
